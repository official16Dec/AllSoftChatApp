...
public class LoginFragment extends Fragment {
    ...
    private boolean validateLogin() {
        ...
        if(binding.userMobileEdit.getText().toString().isEmpty()){
            binding.userMobileEdit.setError("Please type your mobile no");
        }
        else if(binding.userMobileEdit.getText().toString().length() != 10){
            binding.userMobileEdit.setError("Please type valid mobile no");
        }
        else{
        ...
        if(binding.userPassEdit.getText().toString().isEmpty()){
            binding.userPassEdit.setError("Please type password");
        }
        else{
